    ...
    <aside className={`w-[100vw] md:w-[420px] h-full shrink-0 bg-[#f8f7ff] overflow-y-auto p-6 pb-24 md:pb-6 border-r border-gray-100 z-10 fd-sb ${mobileView === 'editor' ? 'block' : 'hidden md:block'}`}>
      ...
      <Acc title="1️⃣ Portada Principal" icon={ImageIcon} defaultOpen iconColor="#ec4899">
        ...
        <div className="relative z-[80]">
          ...
          {/* 👉 NUEVO CONTROL DE SOMBRA Y RESPLANDOR PARA LOS TEXTOS DE PORTADA */}
        ...
        {(cfg.showBadge ?? true) && (
          <div className="relative z-[60]">
            <div className="flex gap-2 relative"><EmojiPicker value={cfg.badgeEmoji} onSelect={v => update("badgeEmoji", v)} /><div className="flex-1"><Inp label="Texto Medalla" value={cfg.badgeText} onChange={v => update("badgeText", v)} placeholder="Ej: 5 añitos" /></div></div>
