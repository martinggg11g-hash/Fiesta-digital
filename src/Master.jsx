...
export const MasterPanel = ({ mySalons, onLogout, onCreateSalon, onUpdateUser, onDeleteSalon, globalAlert, onUpdateAlert }) => {
  ...
  const [fTitular, setFTitular] = useState(""); // 👉 NUEVO ESTADO PARA EL TITULAR
  ...
  const handleSaveModal = () => {
    if (modalMode === "create") {
      ...
      // 👉 Se agrega payment_titular al crear
      ...
      // 👉 Se agrega payment_titular al actualizar
